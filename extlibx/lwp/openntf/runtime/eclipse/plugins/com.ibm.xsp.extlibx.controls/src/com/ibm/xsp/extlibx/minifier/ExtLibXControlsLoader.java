...
package com.ibm.xsp.extlibx.minifier;
...
import com.ibm.xsp.extlibx.plugin.ControlsXPluginActivator;


/**
 * Resource Loader that loads the resource from extlib controls.
 */
public class ExtLibXControlsLoader extends ExtLibLoaderExtension {

	public ExtLibXControlsLoader() {
	}	
	
    @Override
    public Bundle getOSGiBundle() {
        return ControlsXPluginActivator.instance.getBundle();
    }
    ...
    public void loadDojoShortcuts(DoubleMap<String, String> aliases, DoubleMap<String, String> prefixes) {
        ...
        /// Prefixes
        if (prefixes != null){
//            prefixes.put("X","extlibx."); //$NON-NLS-1$ //$NON-NLS-2$
//            prefixes.put("2Xa","extlibx.dijit"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public URL getResourceURL(HttpServletRequest request, String name) {
        ...
        return ExtLibUtil.getResourceURL(ControlsXPluginActivator.instance.getBundle(), path);
    }
}
